...
let images = {
    ...
    showImageWithCurrentIdxAnimationLeft() {
        this.slides[this.currentIdx].classList.remove('hidden-slide');
        this.slides[this.currentIdx].classList.add('animationLeft');
        setTimeout(() => {
            this.slides[this.currentIdx].classList.remove('animationLeft');
        }, 550);
    },

    showImageWithCurrentIdxAnimationRight() {
        this.slides[this.currentIdx].classList.remove('hidden-slide');
        this.slides[this.currentIdx].classList.add('animationRight');
        setTimeout(() => {
            this.slides[this.currentIdx].classList.remove('animationRight');
        }, 550);
    },
    ...
    setNextLeftImage() {
        ...
        this.showImageWithCurrentIdxAnimationLeft();
    },
    ...
    setNextRightImage() {
        ...
        this.showImageWithCurrentIdxAnimationRight();
    },
}
